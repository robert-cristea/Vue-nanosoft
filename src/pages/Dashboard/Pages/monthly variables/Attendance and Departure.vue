                ...
                <div class="md-layout">
                  <div class="md-layout-item md-size-30 ml-15 mtb-25">
                    <md-field>
                      ...
                      <md-select v-model="Type"> </md-select>
                    </md-field>
                  </div>
                  ...
                  <div class="md-layout-item md-size-30 ml-15 mt-25">
                    ...
                    >
                      ...
                      <md-input disabled v-model="Note"></md-input>
                    </md-field>
                  </div>
                  ...
                  <div class="md-layout-item md-size-30 ml-15 mtb-25">
                    <md-field>
                      <md-select v-model="Type">
                        <md-option value="1"
                          >بطاقة الموظف للحضور والإنصراف</md-option
                        >
                        <md-option value="2">ملخص الجدول الزمني</md-option>
                        <md-option value="3"
                          >التقرير الشهري للحضور والإنصراف</md-option
                        >
                      </md-select>
                    </md-field>
                  </div>
                  ...
                  >
                    ...
                    >
                    <md-button @click="clear" class="md-black btn_nanosoft"
                      >طباعة الكل</md-button
                    >
                    <md-button @click="clear" class="md-info btn_nanosoft"
                      >اعتماد</md-button
                    >
                    <md-button @click="clear" class="md-danger btn_nanosoft"
                      >إلغاء الإعتماد</md-button
                    >
                  </div>
                </div>
              </md-card-content>
