              ...
              <md-card-content>
                <div class="md-layout">
                  ...
                  <div class="md-layout-item md-size-30 ml-15 mt-25">
                    <md-field>
                      ...
                      <md-select v-model="ExtraWorkType">
                        <md-option value="1"
                          >مكافآت خاضعة لضريبة الجهاد</md-option
                        >
                        <md-option value="2"
                          >مكافآت خاضعة لكافة الضرائب</md-option
                        >
                      </md-select>
                    </md-field>
                  </div>
                  ...
                  <div
                    ...
                    "
                  >
                    <md-button class="md-success btn_nanosoft" @click="Save"
                      >حفظ</md-button
                    >
                    <md-button class="md-info btn_nanosoft">جديد</md-button>
                  </div>
                </div>
              </md-card-content>
            </md-card>
      ...
      <md-card>
        ...
        <md-card-content>
          <div class="md-layout mt-25">
            ...
            <div class="md-layout-item md-size-100 ml-15 center-content mt-25">
              <md-button class="md-success btn_nanosoft">بحث</md-button>
              <md-button class="md-info btn_nanosoft">إعتماد</md-button>
            </div>
          </div>
