<template>
  <div>
              ...
              <div class="md-layout">
                ...
                >
                  <md-field>
                    ...
                    <md-select v-model="IsAllEmployees">
                      <md-option value="true">كافة الموظفين</md-option>
                      <md-option value="false">موظف واحد</md-option>
                    </md-select>
                  </md-field>
                </div>
                ...
                >
                  <md-field>
                    <label>المستهدف</label>
                    <md-select disabled v-model="IsAllEmployees">
                      <md-option value="true">كافة الموظفين</md-option>
                      <md-option value="false">موظف واحد</md-option>
                    </md-select>
                  </md-field>
                ...
                >
                  ...
                  >
                    <label>الموظف</label>
                    <md-input disabled v-model="employeeFullName"></md-input>
                  </md-field>
                </div>

                <div
                  v-if="IsAllEmployees != 'true'"
                  class="md-layout-item md-size-30 ml-15 mt-25"
                >
                  <md-field
                    :class="[{ 'md-error': failed }, { 'md-valid': passed }]"
                  >
                    <label>رصيد الإجازة</label>
                ...
                >
                  <md-field>
                    <label>نوع الإجازة</label>
                    <md-select disabled v-model="TypeId">
                      <md-option
                        v-for="Type in Type"
                        v-bind:key="Type.id"
                        :value="Type.id"
    ...
    <div v-if="id == '' && IsAllEmployees == 'true'" class="md-layout-item">
      <md-card>
        <md-card-content>
          ...
          >
            <md-table-row slot="md-table-row" slot-scope="{ item }">
              <md-table-cell md-label="المستهدف">{{
    ...
    <div v-if="id != ''" class="md-layout-item">
      <md-card>
        <md-card-content>
          <div class="md-layout flex-content-left">
            <div class="md-size-15 md-layout-item mt-25">
  ...
  methods: {
    ...
    async Save() {
      ...
      try {
        ...
        this.btn = "new";
        this.$router.push("/pages/vacations");
        // this.init();
        // this.clear();
