          ...
          <form>
            <md-card>
              <md-card-header class="md-card-header-text md-card-header-green">
                <div class="card-text">
                  <h4 class="title">Incident Severity</h4>
                </div>
              </md-card-header>
              ...
              <md-card-actions class="text-center">
                ...
                <md-button @click="DeleteUser" v-if="isUpdate" class="md-danger"
                  >Delete</md-button
                >
              </md-card-actions>
            </md-card>
...
export default {
  async created() {
    ...
    let Engneeiers = await axios.get(env.URL() + "Nanosoft/impact", {
      headers: { authorization: tocken }
    });
    this.tableData = Engneeiers.data.result;
  },
  components: {
    Pagination,
    ...
    async DeleteUser() {
      try {
        ...
        let result = await axios.delete(
          env.URL() + "Nanosoft/impact/" + this.id,
          { headers: { authorization: tocken } }
        );
    ...
    async submit() {
      try {
        ...
        if (this.isUpdate === false) {
          result = await axios.post(env.URL() + "Nanosoft/impact/", schema, {
            headers: { authorization: tocken }
          });
        } else {
